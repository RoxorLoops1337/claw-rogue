...
function help(back){
 ...
 openModal('help','THE SALVAGER’S FIELD GUIDE','Aim. Scoop. Survive.','Drag across the glass and release to grab, or aim with the arrows and press Grab. While descending, tap Close Now to choose the depth. Swords, shields, gems, and coins tumble differently. Each finger stops when it meets resistance; loose pieces can slip. Only treasure delivered down the left chute powers your machine.',[
